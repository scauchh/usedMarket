...
public interface TradeService {
    ...
    // 分页获取所有交易
    PageBean<TradeView> getAllTrade(Integer pageNum, Integer pageSize, Integer state);

    // 分页获取发起的交易
    PageBean<TradeView> getTradeFromMe(Integer pageNum, Integer pageSize, Integer state, Integer userID);

    // 分页获取接收的交易
    PageBean<TradeView> getTradeToMe(Integer pageNum, Integer pageSize, Integer state, Integer userID);
}
